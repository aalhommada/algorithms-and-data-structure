...
LeetCode guarantees calls are only made on a non-empty stack. Defensively, you would raise an error or return a sentinel — worth saying aloud in an interview.
</Accordion>
