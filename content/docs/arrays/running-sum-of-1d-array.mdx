...
Only if the caller has no further use for the original values. State that assumption explicitly and offer both versions — noticing the trade-off is part of the answer.
</Accordion>
