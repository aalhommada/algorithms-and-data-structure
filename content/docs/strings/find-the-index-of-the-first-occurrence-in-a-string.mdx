...
In practice the naive version is fine for moderate inputs, and it is the right first solution. Knowing that KMP exists — and *why* the failure table removes the redundancy — is what lets you reach for it when the input is large enough to need it.
